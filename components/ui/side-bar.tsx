...
export function Sidebar({ setIsOpen }: { setIsOpen: (open: boolean) => void }) {
   return (
      <div className="absolute inset-0 w-full min-h-dvh bg-background/60">
         <div className="w-xs ml-auto bg-background h-full">
            <div className="flex flex-col gap-8 pt-6 h-full">
               ...
               <div className="flex flex-col gap-3 px-4 py-4 border-t border-muted-foreground/30">
                  <Button className="items-center justify-center bg-transparent hover:bg-primary hover:text-primary-foreground border border-muted-foreground/30 rounded-lg">
                     Sign In
                  </Button>
